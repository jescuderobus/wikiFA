...
## VITRINA 1. El libro en los siglos XVI - XVIII
[comment]: <> (anteriormente vitrina 5 derecha)
...
- [EL TEATRO DE LA TIERRA UNIVERSAL](vitrina1/elTeatroDeLaTierraUniversal.md)
```txt
...
BUS A Arm. 15/1/10.
```
- [LA ENCICLOPEDIA DE DIDEROT Y D’ALEMBERT](vitrina1/laEnciclopiaDeDiderotyD'Alembert.md)
```txt
...
```
## VITRINA 2. El nacimiento de la Imprenta
[comment]: <> (anteriormente vitrina 5 izquierda)
...
- [LOS TRABAJOS DE HÉRCULES](vitrina2/losTrabajosDeHercules.md)
```txt
...
BUS A Arm. 13/3/19.
```
- [EL LIBRO DE LAS MARAVILLAS](vitrina2/elLibroDeLasMaravillas.md)
```txt
...
- [LA NAVE DE LOS LOCOS](vitrina2/laNaveDeLosLocos.md)
```txt
...
## VITRINA 3. Los libros de devoción
[comment]: <> (anteriormente vitrina 3 derecha)
...
## VITRINA 4. La imagen en el texto.
[comment]: <> (anteriormente vitrina 3 izquierda)
...
- [BIBLIA PAUPERUM](vitrina4/bibliaPauperum.md)
```txt
...
BUS A Arm. 12/032.
```
- [CODEX GRANATENSIS](vitrina4/codexGranatensis.md)
```txt
CODEX GRANATENSIS
...
BUS A Arm. 12/009
``` 
- [TACUINUM SANITATIS](vitrina4/tacuinumSanitatis.md)
```txt
TACUINUM SANITATIS
...
## VITRINA 5. Alfonso X
[comment]: <> (anteriormente vitrina 2 derecha)
...
- [LIBROS DEL AJEDREZ](vitrina5/librosDelAjedrez.md)
```txt
LIBROS DEL AJEDREZ
...
- [LIBROS DEL SABER DE ASTRONOMIA](vitrina5/librosDelSaberDeAstronomia.md)
```txt
...
## VITRINA 6. Los Beatos
[comment]: <> (anteriormente vitrina 2 izquierdo)
...
- [CODEX GERUNDENSIS](vitrina6/codexGerundensis.md)
```txt
CODEX GERUNDENSIS
...
- [BEATO DE LA ABADIA DE SAINT-BEVER](vitrina6/beatoDeLaAbadiaDeSaint-Bever.md)
```txt
...
## VITRINA 7 
[comment]: <> (anteriormente vitrina 4 pequeña)
- [LA BIBLIA DE GUTENBERG](vitrina7/bibliaDeGutemberg.md)
```txt
...
## VITRINA 8.
- [LIBRO DEL CABALLERO ZIFAR](vitrina8/libroDelCaballeroZifar.md)
```txt
...
- [ROMAN DE LA QUÊTE DU GRAAL](vitrina8/romanDeLaQueteDuGraal.md)
```txt
BUS A Arm. 14/1/06-07.
...
## VITRINA 9
[comment]: <> (anteriormente vitrina 1 pequeña)

- [APOCALIPSIS DE LOS DUQUES DE SABOYA](vitrina9/apocalipsisDeLosDuquesDeSaboya.md)
```txt
...
BUS A Arm. 12/011
``` 
- [BEATO DE OSMA](vitrina9/beatoDeOsma.md)
```txt
BEATO DE OSMA
Beato de Osma.
Reprod. facs.
...
## VITRINA 10. Las Cántigas.
[comment]: <> (anteriormente vitrina 6)
- [LAS CANTIGAS](vitrina10/lasCantigas.md)
```txt
LAS CANTIGAS
...
- [EL APOCALIPSIS DE DURERO](vitrina11/elApocalipsisDeDurero.md)
```txt
...
BUS A Arm. 15/1/13(1).
```
- [LA COMPOSICIÓN DEL CUERPO HUMANO](vitrina11/laComposici%C3%B3nDelCuerpoHumano.md)
